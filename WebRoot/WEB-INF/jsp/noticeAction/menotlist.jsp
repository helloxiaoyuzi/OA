...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 个人公告列表
        </div>
...
<div id="MainArea">
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <tbody id="TableData" class="dataContainer" datakey="roleList">
			<tr class="TableDetail1 template" align="center">
				...
				<td>${m.newDate}</td>
				<td>
					<c:if test="${m.user.id eq user.id}">
						<a href="notice_editnot.action?id=${m.id}">编辑</a>
						<a href="notice_delnot.action?id=${m.id}" onclick="return confirm('确定删除？')">删除</a>
					</c:if>
				</td>
			</tr>
        </tbody>
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
          <a href="notice_addnot.action"><img src="${pageContext.request.contextPath}/style/images/createNew.png" /></a> 
        </div>
    </div>
</div>
<!-- 分页信息 -->
