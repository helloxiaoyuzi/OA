...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 修改出差申请表
        </div>
        ...
        <div class="ItemBlockBorder">
            ...
            <div class="ItemBlock">
                <table cellpadding="10" cellspacing="0" class="mainForm">
                    ...
                    <tr><td>出差地址:&nbsp;<s:textfield name="address"></s:textfield></td>
