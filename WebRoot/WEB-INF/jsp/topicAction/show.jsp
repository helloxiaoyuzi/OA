...
<div id="MainArea">
	...
	<center>
		...
		<div class="ForumPageTableBorder dataContainer" datakey="replyList">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<td width="3" class="ForumPageTableTitleLeft">&nbsp;</td>
					...
					<td class="ForumPageTableTitle" align="right" style="padding-right:12px;">
						...
						--><a href="${pageContext.request.contextPath}/topic_setJingHua.action?topicId=${topic.id}" onClick="return confirm('要把本主题设为精华吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/topicType_1.gif" />精华</a>
						<a href="${pageContext.request.contextPath}/topic_setZhiDing.action?topicId=${topic.id}" onClick="return confirm('要把本主题设为置顶吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/topicType_2.gif" />置顶</a>
						<a href="${pageContext.request.contextPath}/topic_setPuTong.action?topicId=${topic.id}" onClick="return confirm('要把本主题设为普通吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/topicType_0.gif" />普通</a>
					</td>
						...
						<td align="center">
							<ul class="TopicFunc">
								...
								<li class="TopicFuncLi">
									...
									--><a class="detail" href="${pageContext.request.contextPath}/topic_delTopic.action?topicId=${topic.id}&forumId=${topic.forum.id}" onClick="return confirm('确定要删除本帖吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/delete.gif" />删除</a>
								</li>
								<!-- 文章的标题 -->
			...
			<!-- ~~~~~~~~~~~~~~~ 显示回复列表 ~~~~~~~~~~~~~~~ -->
			<s:iterator value="recordList" status="status"><c:if test="${del eq null}">
					...
					<tr>
						...
						<td align="center">
							<ul class="TopicFunc">
								...
								<li class="TopicFuncLi">
									<!--<a class="detail" href="${pageContext.request.contextPath}/BBS_Topic/saveUI.html"><img border="0" src="${pageContext.request.contextPath}/style/images/edit.gif" />编辑</a>
									--><a class="detail" href="${pageContext.request.contextPath}/reply_delReply.action?topicId=${topic.id}&replyId=${id}" onClick="return confirm('确定要删除本帖吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/delete.gif" />删除</a>
								</li>
								<!-- 文章表情与标题 -->
								<li class="TopicSubject">
									${title}
