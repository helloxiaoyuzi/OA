    ...
    $(function(){
	    ...
	    $("#sub").click(function(){
	     ...
	     var meetname="";
	    	...
	    	$("input[name='ids']").val(ids.substr(0,ids.length-1));
	    	$("input[name='meetname']").val(meetname.substr(0,meetname.length-1));
	   	  	$("#form1").attr("action","print_verify.action");
...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 公章预定管理
        </div>
...
<!--显示表单内容-->
<div id="MainArea">
    <form action="print_backApply.action" method="post" id="form1">
        ...
        <tbody id="TableData" class="dataContainer" datakey="rooms">
          <c:forEach items="${orderapplylist}" var="avroom">
            <tr class="TableDetail1 template">
                ...
                <td width="20%">${avroom.cachetId.name}&nbsp;</td>
                <td  width="20%">${avroom.appuserId.name}&nbsp;</td>  
                <td>${avroom.appdepId.name}&nbsp;</td>    
               <td>${avroom.appDate}&nbsp;</td> 
               <td>${avroom.content}&nbsp;</td>   
                <td>
