...
<body CLASS=PageBody leftmargin=0 topmargin=0 marginwidth=0
	...
	<div id="Head1">
		<div id="Logo">
			<img border="0" src="${pageContext.request.contextPath}/style/blue/images/logo2.gif" />
		</div>
		<div id="Head1Right">
			...
			<div id="Head1Right_UserSetup">
				<a href="userinfo_list.action" target="right"><img border="0" width="13"
					height="14"
		...
		<div id="Head1Right_SystemButton">
			...
			</a> <a target="right" href="${pageContext.request.contextPath}/home_right.action"><img width="65"
				height="20" alt="显示桌面"
               ...
               -->
				...
				<li><!-- <a href="javascript:void(0)"
					...
					target="right"> <img border="0" width="12" height="14"
						...
						待办事项（<span id="wait" class="taskListSize">0</span>） </a> -->
				</li>
